...
![The Frequency Safety Zone and August 9, 2019 Trajectory](figures/figure_1_1_frequency_safety_zone.png)

![August 9, 2019 Frequency Data](figures/figure_1_2_blackout_baseline.png)
...
![Physics of Grid Stability - Inertia and Frequency Dynamics](figures/figure_2_1_swing_equation.png)
...
![OpSDA Compression](figures/figure_3_2_opsda_compression.png)
...
![Quantile Concept](figures/figure_3_3_quantile_concept.png)
...
### Table 4.1: Quantile Regression Performance Metrics (August 2019)
...
![Model Performance](figures/figure_4_1_model_performance.png)
...
![Stable Period Validation](figures/figure_4_3_stable_period.png)
...
### Figure 4.2: Feature Importance Rankings (SHAP-based)
...
![Feature Importance](figures/figure_4_2_feature_importance.png)

![Feature Stability](figures/figure_4_6_feature_stability.png)
...
| **Calibration (α=0.1)** | 10.1% | 5.9% | −4.2 pp | ⚠️ Conservative |
...
![Seasonal Comparison](figures/figure_4_5_seasonal_comparison.png)

![Residual Analysis](figures/figure_4_4_residual_analysis.png)
...
![Blackout Alert](figures/figure_5_1_blackout_alert.png)
...
**Figure 5.2: Reliability Diagram — Quantile Calibration (August 2019)**
...
![Calibration Reliability](figures/figure_5_4_calibration_reliability.png)
...
![SHAP Beeswarm](figures/figure_5_5_shap_summary_beeswarm.png)
...
![Intervention Simulation](figures/figure_5_3_intervention_simulation.png)
...
#### Table B.2: Instability Detection Metrics (August 9, 2019 Blackout)
...
### Feature Importance Stability (Temporal Windows)
...
*Metrics represent Mean Absolute SHAP importance for the lower bound (α=0.1) model.*
...
#### Binary Classifier Metrics (Blackout Day)

| Metric | Value | Target | Status |
|--------|-------|--------|--------|
| **Precision** | 0.889 | >0.85 | ✅ Pass |
| **Recall** | 0.210 | >0.80 | ❌ Fail |
| **F1-Score** | 0.339 | >0.85 | ❌ Fail |
