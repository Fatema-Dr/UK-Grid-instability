...
print(f"{'Time':<20} | {'Freq':<7} | {'RoCoF':<8} | {'Accel':<8} | {'SigCnt':<6} | {'Emerg':<6} | {'LB':<7}")
for idx, row in df_sub.iterrows():
    ...
    print(f"{t:<20} | {freq_now:<7.4f} | {rocof_now:<8.5f} | {rocof_accel:<8.5f} | {signal_count:<6} | {emergency_trigger} | {lb:<7.4f}")
